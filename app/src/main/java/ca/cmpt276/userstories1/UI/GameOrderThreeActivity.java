 ...
 */
public class GameOrderThreeActivity extends AppCompatActivity {
    ...
    TextView draw_one, draw_two, draw_three, draw_four;
    TextView discard_one, discard_two, discard_three, discard_four;
    ...
    private Chronometer timer_for_order3;
    boolean[] forDraw;
    boolean[] forDiscard;
    ...
    public static Intent makeIntent(Context context, String message) {
        Intent intent = new Intent(context, GameOrderThreeActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        game_music = MediaPlayer.create(GameOrderThreeActivity.this, R.raw.game_music);
        game_music.setLooping(true);
        game_music.setVolume((float) 0.1, (float) 0.1);
        game_music.start();

        win_sound_order = MediaPlayer.create(GameOrderThreeActivity.this, R.raw.win_sound);
        ...
        deck = new Deck(4, cards);
        scoreBoard = new ScoreBoardHelper(this, 4, cards);

        setupIntialButtons();
        updateUI();

        timer_for_order3 = findViewById(R.id.game_timer_for_order3);
        timer_for_order3.setBase(SystemClock.elapsedRealtime());
        timer_for_order3.start();
    }
    ...
    private void setupIntialButtons() {
        ...
        draw_first = findViewById(R.id.draw_imageone);
        draw_second = findViewById(R.id.draw_imagetwo);
        draw_third = findViewById(R.id.draw_imagethree);
        draw_fourth = findViewById(R.id.draw_imagefour);

        discard_first = findViewById(R.id.discard_imageone);
        discard_second = findViewById(R.id.discard_imagetwo);
        discard_third = findViewById(R.id.discard_imagethree);
        discard_fourth = findViewById(R.id.discard_imagefour);
        ...
        forDiscard = new boolean[13];
        forDraw = new boolean[13];
    ...
    private void setUpClickables() {
        imageView_buttons = new ImageView[4];
        textView_buttons = new TextView[4];
        fillButtonArrays();
            ...
            if (startingCard.contains(topOfDeck.get(i))) {
                imageView_buttons[i].setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        MediaPlayer correct_sound = MediaPlayer.create(GameOrderThreeActivity.this, R.raw.sound_for_correct_card);
                ...
                imageView_buttons[i].setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(GameOrderThreeActivity.this, "Try again!", Toast.LENGTH_SHORT).show();
                        MediaPlayer incorrect_sound = MediaPlayer.create(GameOrderThreeActivity.this, R.raw.sound_for_incorrect_card);
    ...
    private void updateUI() {
        ...
        if (deck.isEmpty()) {
            timer_for_order3.stop();
            int elapsed = (int) (SystemClock.elapsedRealtime() - timer_for_order3.getBase());
